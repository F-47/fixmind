...
| [docs/mcp-integration.md](docs/mcp-integration.md) | The MCP server, its tools and memory retrieval, plus manual client setup. |
...
| [`apps/website`](apps/website) | `@fixmind/website`, the Next.js marketing site. |
