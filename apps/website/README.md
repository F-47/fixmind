...
The marketing site for fixmind — a static-output, client-side-routed React app. No backend, no build-time data fetching; it's copy and a few interactive bits (clipboard buttons, smooth-scroll nav).
