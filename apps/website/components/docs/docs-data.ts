...
const BASE_DOCS: DocEntry[] = [
  {
    id: "quickstart",
    title: "Quickstart",
    summary: "Install, set up, and see what happens on your first fix.",
  ...
  },
  {
    ...
    summary: "Connect Claude Code, Cursor, Codex, and other MCP clients.",
  ...
  },
  {
    id: "commands",
    title: "Commands",
    summary: "Every command and flag: setup, capture, browse, review, edit, and export.",
  ...
  },
  {
    id: "lesson-schema",
    title: "Lesson Schema",
    summary: "Lesson contents, quality gates, spaced repetition, and local storage.",
  ...
  },
  {
    ...
    summary: "Troubleshoot saving, backups, resets, and client-specific scope quirks.",
